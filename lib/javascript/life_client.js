function LifeClient() {
    ...
    this.notify= undefined; // function(LifeMessage)
...
// send a LifeMessage
LifeClient.prototype.send = function(msg, on_success, on_error) {
    this.logger.debug("LifeClient.send: msg=" + msg.toSource());
    ...
    this.sender.sendMessage(msg, on_success, on_error);
}
