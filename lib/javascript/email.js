...
SslSmtpClient.prototype.sendMessage = function(tag, to, subject, related, html, txt, base64, on_success, on_error) {
    log("sendMessage: tag=" + tag + " to=" + to.toSource() + " subject=" + subject + " base64=" + base64);
    ...
    data += "Subject: [Life][" + tag + "] " + encode_utf8(subject) + "\r\n";
